          ...
          children: [
            ...
            Column(
              children: [
                ...
                (_plans.isEmpty)?Padding(padding:EdgeInsets.symmetric(vertical: 96),child: Text("You do not have suggestions currently")):SizedBox(
                  height: (_plans.length)*125,
                              ...
                              GestureDetector(
                                onTap: ()async {
                                  await plansProvider.addEnrollment(
                                      plan_id: _plans[i].plan!.id.toString());
